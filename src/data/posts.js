// Blog images — existing 4
import imgConfessions from '../assets/blog/confessions-of-a-sinner.jpg'
import imgLies from '../assets/blog/the-lies-we-learn-to-love.jpg'
import imgUpdate from '../assets/blog/amburn-ministries-update.jpg'
import imgStorm from '../assets/blog/when-the-storm-didnt-break-me.jpg'
// Blog images — full archive
import imgFulfilledDreams from '../assets/blog/fulfilled-dreams.jpg'
import imgPigHeaded from '../assets/blog/i-was-so-pig-headed.jpg'
import imgLostSouls from '../assets/blog/lost-souls-and-hard-hearts.jpg'
import imgAngels from '../assets/blog/angels-in-waiting.jpg'
import imgDeer from '../assets/blog/deer-in-the-headlights.webp'
import imgLongest5 from '../assets/blog/the-longest-5-years.jpg'
import imgRealLife from '../assets/blog/real-life-encounters.jpg'
import imgWhyYouMatter from '../assets/blog/why-you-matter-to-me.jpg'
import imgPeace from '../assets/blog/peace-within-the-darkness.jpg'
import imgWhatLove from '../assets/blog/what-does-love-look-like.jpg'
import imgChristmasMugs from '../assets/blog/a-tale-of-two-christmas-mugs.jpg'
import imgTryHard from '../assets/blog/you-dont-have-to-try-so-hard.jpg'
import imgFalseAd from '../assets/blog/false-advertisement.jpg'
import imgWhyFeet from '../assets/blog/why-feet.jpg'
import imgLovePoverty from '../assets/blog/love-and-poverty.webp'
import imgKarma from '../assets/blog/the-power-of-karma.webp'
import imgGiants from '../assets/blog/standing-against-the-giants.webp'
import imgFather from '../assets/blog/father.jpg'
import imgFromPain from '../assets/blog/from-pain-to-purpose.jpg'
import imgItsForYou from '../assets/blog/its-for-you.jpg'
import imgToday from '../assets/blog/today-i-had-something.jpg'
import imgRedemption from '../assets/blog/redemption.jpg'
import imgDemonic from '../assets/blog/demonic-attacks.jpg'
import imgSecrets from '../assets/blog/the-secrets-we-keep.jpg'
import imgConspiracies from '../assets/blog/conspiracies.webp'
import imgPicnic from '../assets/blog/life-is-not-a-picnic.webp'
import imgNightToRemember from '../assets/blog/a-night-to-remember.webp'
import imgWhatsComing from '../assets/blog/whats-to-come.jpg'
import imgOde from '../assets/blog/ode-to-you.jpg'
import imgRealPower from '../assets/blog/real-power.jpg'
import imgNoneOfYour from '../assets/blog/none-of-your-bidness.jpg'
import imgWorry from '../assets/blog/fighting-roots-of-worry.jpg'
import imgDreams from '../assets/blog/lessons-in-dreams.jpg'
import imgJourneyHealing from '../assets/blog/the-journey-to-healing-deliverance.jpg'
import imgSignsWonders from '../assets/blog/signs-and-wonders.webp'
import imgMusicDarkness from '../assets/blog/music-through-the-darkness.jpg'
...
Sometimes memories come in pieces… especially after so many years pass…

You don't ever forget… it just feels like you remember less…

I guess when you choose life over death in so many areas… it affects your memory too…

But all it takes is one curious child… or one passing conversation… and click…

There it is… ready or not… here it comes…

My wife, Katrina, often says that I'm a good man… a good father…

I don't always see it…

Still… it means a lot… because I wasn't always that way…

We don't always see ourselves the way others see us… do we?…

For years… I lived mostly for myself…

Abuse operates like that…

It makes things complicated… hard to tell what was self-protection… and what was survival…

After 24 years of "togetherness" and marriage… all I really knew how to do was survive…
...
I tried daily to dream… to hope… to plan…

But I tripped… and tripped…

Every part of me was contended… controlled…

Most of that tripping came from trying not to set off land mines…

If you've experienced control… you get it…

Living that way took precious energy…

Connection…

Time…

It took me away from people who didn't deserve my emotional… and mental absence…

I was talking with a family member the other day…

He opened up to me about that absence…

He saw me as a father…

I saw him as a son…

But I knew my life choices…

My marital decisions…

My internal angst…

They weren't a good example…

So I deliberately pushed him away…

I thought I was saving him from me…

I didn't want him to make the same choices I did…

I didn't want his decisions shaped by familiarity with my life…
...
He told me that meant more than I knew…

Because he'd been wrestling for years with the why…

The rejection of a father figure…

The internal struggle it caused…

And just like that…

One of those vivid memories kicked in…

He said…

"I remember seeing you sitting on the couch late at night…
Watching you worship the Lord after a long day of work…
Every moment of downtime you had… your head was down… your hand resting on your forehead…
You were still there…
All of that… it was a response to trauma…"

I replied…

"The trauma was bad…
My stories make military war vets cringe…
Katrina has been redemption for me…
Her stability and love have been a rope ladder out of the pit I lived in…
You were never part of that pit…
There were times I hadn't slept for days… and I still made time for you…
Times I was secretly coughing blood after a fight with Vanessa… and still sat down with you…
But I also projected on you…
Because I didn't want you to be like me…
I didn't want my life… to become yours…"

That's when the memory unlocked fully…

I felt it… deep in that dark place…

The cellar where everything you never wanted is stored…

That place where… if you peer through the cracks in the floor… your stomach drops…

Feelings you thought were long gone…

Surface…

Reconnect to memory…

It's like finding mice have built nests from your keepsakes…

Contaminated… but not disposable…
...
A lost soul knows nothing else…
...
I reread our texts over and over…

I wanted to rebrand my memory…

To pluck out the violence and exhaustion…

And replace them with the truth of my nephew's perspective…

Because truth… is light… to a lost soul…

The part that let the light in… was this…

"Sitting on the couch late at night…
Watching you worship the Lord after a long day of work…"
...
I couldn't break through the veil…
...
I always felt like one of the lesser Bible stories that didn't make the cut…

Like the guy in the nose-bleed section of the 5,000 on the hillside…

Catching every other word Jesus spoke…

Or the one who walked thirty miles…

And arrived thirty minutes after Jesus left…
...
I've learned that everyone feels this way…

In some form…

We treat Jesus like a celebrity…
...
That's not the Jesus I discovered…

I discovered the most real… honest… understanding… sympathetic… kind…

Conversational person I've ever known…
...
I used to think it was strange to talk to God…

I thought He couldn't hear me…

That I was too far up in the bleachers at His conference…

Maybe if I got lucky…

I'd get ten seconds with Him…

And everything would be fixed…

But God is near…

The Bible says that as we draw near to Him…
...
If we seek Him with our whole heart…

And I did seek Him…

I wanted to know Him…

I knew there was more than what I saw…

More than my damaged… jaded surroundings…

And the moment I found God…

Was the moment I stopped striving…

And started receiving…

I laid down expectations…

I stepped into time with Him…

I read the Bible without bending it to my narrative…

And I chose… to trust… what I read…

Thank you for reading this all the way through…

I hope it was worth your ten minutes…

Michael

If you'd like to read more reflections like this…
You can visit: AmburnMinistries.com/blog

---

Extra:

If you're still here… and you want to sit with this a little longer…

This song came from the same place as this story… Enjoy…

This Is Where The Light Gets In

Vs1:
Every page…
And every sentence read…
Shines a light…
A holy common thread…
The human heart is waiting here and longing for the truth…
It's in the soul…
This urge for something more…
An empty hole…
Made in the image of…
The Fathers love and it's reaching out and drawing close to you…

Pre-chorus:
In a world that's closed the book…
It's time to take a deeper look…

Chorus:
This is where the light gets in…
Like opening a stubborn door…
This is where your life begins…
Cause life in Christ gives so much more…
This is where the light gets in…
The pages of the living Word…
This is where the healing is…
Restoring you from years of hurt…

Vs 2:
The curtains blow…
And dusty rays of light…
Begin to show…
The hidden truths that lie…
About and wait for you to stumble or to fail…
But once inside…
The windows and the doors…
Blow open wide…
And truth can't be ignored…
And all at once in just a moment…
You breathe in and come alive…

Bridge:
Go on and run through all the halls…
Fling open closets… clear the walls…
This is the day that you received…
That hour when you first believed…`,
  },
  {
...
If you'd like to read more blogs like this, you can visit: Amburnministries.com/blog`,
  },
  {
    ...
    date: 'January 6, 2026',
    authors: 'Michael & Katrina',
    readTime: '4 min read',
    tag: 'Faith',
    image: imgConfessions,
    excerpt: 'I was desperate enough to look for God anywhere…',
    body: `(About a 5 min read… if religion ever pushed you away from God, stay with me.)
...
🤍`,
  ...
  {
    slug: 'the-lies-we-learn-to-love',
    title: 'The Lies We Learn To Love',
    date: 'December 13, 2025',
    authors: 'Michael & Katrina',
    readTime: '4 min read',
    tag: 'Healing',
    image: imgLies,
    excerpt: 'The other day I was thinking about difficult seasons in my life… I had so many of them I could have started a lemonade factory or silver lining production company…',
    body: `(About a 5 min read… breathe and read slowly… there’s a reward at the end…)

The other day I was thinking about difficult seasons in my life… I had so many of them I could have started a lemonade factory or silver lining production company…

One situation resurfaced… most inconveniently… as they always do… it resulted in an emotional shutdown… and then a break down… and I was left to process something that I didn’t want to face…

I’ve learned over the years that no one is immune to difficulties… setbacks are part of life… we plan and learn, ebb and flow… but there are always challenges… I used to think “well, if I had enough money… then I wouldn’t have these problems…” but the truth is… yes… you may not have those financial problems… however, you’ll trade them for other problems that come with having excess money…

The process brewed for two weeks… and then formed a painful head… like and irritating pimple… it was deep and I just couldn’t get to it…

I was reminded of a time in my late 20’s…my life was creatively chaotic… and my late wife couldn’t take it anymore… she gave me an ultimatum… go to the doctor and get this figured out, or I’m divorcing you… it cut to my heart… the feeling of not being accepted as I was… i was given the choice to conform or lose what I saw as love…

My core thrives on relationship… its power… its kingdom… so I obeyed and went to the doctor…

Through hours of scans and testing… I received a diagnosis… “this is the worst case I’ve ever seen, Michael” the doctor said… I felt damaged… I felt like everything that was spoken over me my whole life was true…

He proceeded to give me options… medication suggestions… that would alter my personality and help me to conform… and with the ultimatum i was given… I submitted…

I started to take medication… and my life started to change… my weaknesses became strengths… but my creativity entirely disappeared… amy strengths became non-existent… I felt like I traded my passion, purpose and creativity for a bowl of beans… like Esau must have felt after making a desperate and foolish trade to Jacob…

Fast forward to recently… it was like a vivid flashback… I relived the moment deep in my mind and deeper in my heart… I saw the truth from the inside out… and this was the moment that I began to take hold of what was never mine to carry… the lie that i must conform… to be…

The beautiful thing about remembering… or discovering a root is that once you’ve discovered it, you can remove it… so I did…

I stepped into a new awakening… an internal confrontation to never submit to the lie that love is based on conformity… I shook it off like a snake shedding its old skin and stepped into a newness of reality… I discovered ME again… and released the lies I learned to love and hold so close too my identity…

Moments like these are like opportunities… they don’t come through you forcing yourself to change… they come with truth exposing the lies inside you…

Let me encourage you with this… if you’ve been holding onto lies about who you are… ask the lord to show them to you… don’t be afraid to release them to the one who loves you most… God will never condemn you… he wants to remove the sliver… gently… patiently… so you can heal…
...
To read more stories like this one you can visit us at amburnministries.com/blog

Extra:

This is a song I wrote that was birthed out of this realization… it’s in lyric form so you can absorb the message:

The Lies We Learn To Love

Vs1:

You felt worthless…

So you never made a sound…

Real but earth-less…

Like you were floating in the clouds…

Dress to impress…

Because no one knew your name…
...
These are the moments that we must…

Know the Fathers Love for us…

Cause in this place of honest trust…

We release the lies we learn to love…

Vs2:

“Its human nature…”

When they spoke about their sin…
...
Left you wondering what you missed…

As you compared to…

Others freedom and success…
...
Patterns and behaviors turn to dust…

The chains that held you down begin to rust…

Cause when learn what Jesus did for us…

We replace the lies we learn to love…
...
We release the lies we learn to love…`,
  ...
  {
    slug: 'amburn-ministries-update',
    title: 'Amburn Ministries Update',
    date: 'December 1, 2025',
    authors: 'Michael & Katrina',
    readTime: '2 min read',
    tag: 'Update',
    image: imgUpdate,
    excerpt: 'Over the last several months, Katrina and I have stepped into a brand-new season—one that’s been forming in our hearts for years. After eight incredible years serving and leading worship at Charis, our time there has come to a close.',
    body: `Over the last several months, Katrina and I have stepped into a brand-new season—one that’s been forming in our hearts for years. After eight incredible years serving and leading worship at Charis, our time there has come to a close. We’re deeply grateful for everything God did in and through that season, and even more grateful for the people who walked beside us.

But we’re not “leaving ministry.”

We’re stepping further into it.

We’ve always believed ministry isn’t a platform—it’s a posture. And God has been calling us into something far more personal, relational, and presence-driven than anything we’ve done before.

Here’s what’s unfolding right now:

1. Awaken My Heart Gatherings (Home Worship Encounters)

We’re innitiating intimate, Spirit-led gatherings where worship, teaching, prayer, and authentic encounter with God happen around the table—not a stage. These aren’t services. These are spaces for real hearts, real healing, and real presence.

2. New Music & Worship Projects

Michael is writing more than ever before—songs that carry testimony, healing, identity, and the heartbeat of the Father. We’ll be releasing new worship projects, stripped-down sessions, and devotional songs designed to awaken people to the presence of God.

3. The Amburn Ministries Vision

Our heart is simple:

Help people encounter Jesus—deeply, personally, authentically.

Through music, discipleship, story, teaching, and gatherings… we’re building a ministry that fathers and mothers the overlooked, the hungry, and the ones God is pulling into deeper waters.

4. Two New Books in Development

Michael is writing Overcomer and Texting With God, two projects that weave testimony, encounter, and practical spiritual identity into accessible, life-changing narratives.

5. Partnering With the Body of Christ in Colorado and Beyond

We’re saying “yes” to worship nights, small gatherings, home churches, missions invitations, and anywhere God leads us to encourage believers into intimacy and identity.

Why this shift?

Because God asked us to slow down, listen, and obey.

This isn’t a reaction.

It’s alignment.

The Lord has been moving us from the wide lense to presence,

from ministry-on-demand to ministry-by-design,

from institutional structure to relational discipleship.

We’re excited, humbled, and honestly a little undone by what God is birthing—but we are here for it.
...
And if God prompts you, walk alongside us as we build what He’s breathing on in this season.
...
And we’re grateful you’re part of our story.

More soon…

Michael & Katrina Amstutz-Washburn

Amburn Ministries`,
  },
  {
    slug: 'when-the-storm-didnt-break-me',
    title: "When the Storm Didn't Break Me",
    date: 'December 1, 2025',
    authors: 'Michael & Katrina',
    readTime: '2 min read',
    tag: 'Testimony',
    image: imgStorm,
    excerpt: 'I’ve lived long enough to see storms build slowly… the kind that start with a whisper in the distance before you even realize you’re standing in the wrong place.',
    body: `(About a 4–5 min read)
...
Michael`,
  ...
  {
    slug: 'dont-give-up-about-a-3-min-read-the-end-is-the-best-part',
    title: "Don't Give Up",
    date: 'March 3, 2025',
    authors: 'Michael & Katrina',
    readTime: '3 min read',
    tag: 'Faith',
    image: imgDontGiveUp,
    excerpt: 'I’m not a quitter by nature… there’s something inside me that just doesn’t stop… maybe it’s the past failures, or possibly the need to impress… or maybe it’s me “doing to be” instead of “being to do”… one thing I do know well, however, is that I c...',
    body: `(About a 3 min read… the end is the best part…)
...
If you’d like to read more stories like these, you can visit:

Amburnministries.com/blog`,
  },
  {
    slug: 'none-of-your-bidness',
    title: 'None of Your Bidness',
    date: 'March 3, 2025',
    authors: 'Michael & Katrina',
    readTime: '4 min read',
    tag: 'Story',
    image: imgNoneOfYour,
    excerpt: 'I was 15… working to support my family at a local grocery store… we lived in the projects… or more softly said “low income housing”… by the way we lived, it was pretty clear that we didn’t have much money… I wish I could say my dad was an honorabl...',
    body: `(About a 9 min read… and yes… you read that correctly!)
...
Thank you for reading this all the way through. For more stories like these you can visit amburnministries.com/Blog`,
  },
  {
    ...
    tag: 'Story',
    image: imgAngels,
    excerpt: 'Some said I was fearless… others said I was an idiot… I like to think of myself as surrounded by angels…',
    body: `(About an 8 min read… Do You Have Stories Like This? Or Am I The Only One?)

Some said I was fearless… others said I was an idiot… I like to think of myself as surrounded by angels…

I know it isn’t true… however, with all of the hare-brained things I’ve done… I like to think my angels are missing limbs, limping and wearing eye-patches… due to my incessant need to take risks…

I’ve often wondered about angels… I’ve had so many “impossible experiences” where I should have died… but there was so much protection… let me share a few with you:

22 Feet Down:

I went to measure a roof for someone I knew… they needed help and didn’t have the money to do it… it was at least 20 years expired… the shingles were disintegrating under my feet as I slowly made my way across the roof ridge… cautious with every move, I tensely extended my measuring tape to collect my necessary data… after about an hour of a substantial core workout from balancing so intensely… I had just about gathered what I needed when suddenly, I felt the shingles give way under my feet… it was like someone poured pea gravel on the roof top and took my feet right out from underneath me…

Now… I had fallen off rooftops too many times to count… so I knew what to do… the first thing was to instantly regret my decision to be up there in the first place… but then I grabbed my hammer and attempted to sink it into the roof sheeting… over and over again I slammed the hammer claw with absolutely no bite…

The roof was a 10/12 pitch… which usually wouldn’t be a problem if not for the roller skates that seemed to effortlessly carry me to the roofs edge…

My feet hit the gutters… my sigh of relief was cut short when the gutters gave way as if they weren’t attached at all… I swung my hammer in hopes to catch the slowly detaching gutter and ride it to the ground… however… it didn’t happen… I looked down and saw a 22’ distance between me and the quickly approaching deck below… the deck was old and dilapidated… also in much need of repair…

Now in mid air I was falling face first… but somehow managed to roll, curl my knees in and tuck my head into a fetal position with my back now facing down… I felt the rush of air leave my lungs and hit the deck hard… instantly, everything went black…

When I first arrived at the home it was about 7am… the owners weren’t home and had left for the weekend…

I remember waking up to the worst pain I’ve ever felt… I let out an excruciating yell… and slowly realized what happened… it took a few mins to be able to move… I was wedged down between two deck joists as I’d broken the boards from my impact… I was numb… I was certain I’d broken my back… then suddenly I realized that the sun had gone down… I looked at my watch and it said 9pm…

I slowly forced myself up to my feet… and one foot in front of the other… I made my way to my truck and drove an hour home…

When I arrived home… my late wife had gone to bed… this was her usual response in those days… I hobbled to the bathroom, took a shower and noticed blood in my urine…

I remember going to bed and sleeping for two days… I was out of work for two weeks, but I recovered quickly… I’ve known people to die from an 8’ fall… and I’m certain the prayers of those who loved me had kept me alive….

There’s a Right Way… and a Stupid Way:

Shortly after I was first married, I was given a 1994 Ford Taurus Wagon… it was navy blue with a white front door… I’m sure you’ve seen cars like that… and judged them… lol…

I was broken in those days and developed my MacGyver skills in the school of hard knocks… this was long before YouTube…

My car was on its last leg… I’m certain it was running on 2 cylinders… it knocked and thudded until one day it officially died… as life would have it… I had just filled the gas tank to the top… right before it gave up the ghost… I was so frustrated… I thought to myself “I have got to get that gas out before I scrap it”…

So I looked around the car… under the car… in the car… to see if there was anything I could use to siphon the gas… then I suddenly had an idea… a incredibly wonderful awful idea…

I went into the house and grabbed a hose… I’d seen someone do this on TV… so it had to work… I came outside with a bucket and shoved the hose down into the tank… I proceeded to suck on the hose until the gas started to come out… it didn’t… so I sucked harder and suddenly I received an excoriating mouthful of gas with no benefit to me… because the gas didn’t keep coming out… frustrated and gagging from the experience, I had yet another marvelous idea…

I ran into the house again, and grabbed my cordless drill… I thought to myself “I’m scrapping it anyway… why not try to drill a hole in the tank”… I jacked up the car and got my buckets ready… determined to retrieve my lost investment…

I started slow… small sparks started to spray… but I didn’t think anything of it… after about 5 mins of oblivious determination… the hot bit punctured the tank and gas began to flow out… I quickly positioned my buckets and swapped them out as they would fill… three buckets later I cleaned myself up and went to bed… looking back, I imagine my angels blowing on that bit and catching every spark…

God has this way of protecting us… to this day, I covet the prayers of those who would pray for me… I deeply believe in angels and that God sends them to protect His kids and work on their behalf…

For more stories like this you can  visit amburnministries.com/blog

Do you have stories like this?! Share them in the comments below! 👇🏻👇🏻`,
  },
  {
    ...
    readTime: '8 min read',
    tag: 'Story',
    image: imgNightToRemember,
    excerpt: 'We had a plan… I was notorious for surprises… and loved them… however, I learned quickly how much she didn’t…',
    body: `(About a 8 min read… and… it’s sad…)
...
🤍`,
  ...
  {
    slug: 'life-is-not-a-picnic',
    title: 'Life Is Not a Picnic',
    date: 'July 26, 2024',
    authors: 'Michael & Katrina',
    readTime: '5 min read',
    tag: 'Faith',
    image: imgPicnic,
    excerpt: 'Like so many days, we were getting ready for church… it was the thing to do… and I went because my wife went… however, I did enjoy the connections with people…',
    body: `(About a 5 min read… do you relate?)
...
🤍`,
  ...
  {
    slug: 'love-and-poverty',
    title: 'Love and Poverty',
    date: 'July 14, 2024',
    authors: 'Michael & Katrina',
    readTime: '5 min read',
    tag: 'Faith',
    image: imgLovePoverty,
    excerpt: 'Love and Poverty',
    body: `Love and Poverty
...
🤍`,
  ...
  {
    slug: 'ode-to-you-or-owed-to-you',
    title: 'Ode To You Or Owed To You',
    date: 'June 16, 2024',
    authors: 'Michael & Katrina',
    readTime: '5 min read',
    tag: 'Story',
    image: imgOde,
    excerpt: 'Father’s Day is bitter sweet… every year, I experience two contrasts… my Dad died about two years ago… he was a poor and broken man who lived a life for himself…',
    body: `(About a 5 min read… it’s pretty deep…)
...
🤍`,
  ...
  {
    slug: 'signs-and-wonders',
    title: 'Signs and Wonders',
    date: 'February 25, 2024',
    authors: 'Michael & Katrina',
    readTime: '8 min read',
    tag: 'Testimony',
    image: imgSignsWonders,
    excerpt: 'It was a beautiful August in Colorado… I tried to appreciate it… I loved the aspens and being in nature through the turning of the seasons… however, the stress of our battle with cancer had worn me down… it was hard to find joy in anything except ...',
    body: `(About a 8 min read… the end isn’t what you might think…)
...
🤍`,
  },
  {
    ...
    tag: 'Faith',
    image: imgKarma,
    excerpt: 'I was living in Northern California… the weather was beautiful… however, the area was rampant with the homeless and travelers… we were travelers…my late wife, three kids and I lived in a renovated school bus… we fit the profile in appearance, but ...',
    body: `(About a 6min read… if you invest in it… good things will come…)
...
🤍`,
  },
  {
    ...
    tag: 'Faith',
    image: imgWhyFeet,
    excerpt: 'Let\'s be real. Most people cringe over their feet let alone others feet.',
    body: `(About a 6-7min read)

Let's be real. Most people cringe over their feet let alone others feet. What is it about feet that people don't like? The shape? The smell? How dirty they can be?
...
You are VALUABLE ❤️ HEAL RESTORE DELIVER
...
🤍`,
  ...
  {
    slug: 'lost-souls-and-hard-hearts',
    title: 'Lost Souls and Hard Hearts',
    date: 'February 12, 2024',
    authors: 'Michael & Katrina',
    readTime: '5 min read',
    tag: 'Ministry',
    image: imgLostSouls,
    excerpt: 'I’ve seen it before… I’ve stopped and listened to their truth… lies… or simply whatever stories they felt safe to tell… the streets make hearts hard… like an unruly prison… hurt… loss… it’s their every day reality… their biggest fears are weather ...',
    body: `(About a 5 min read… it might improve your reach!)
...
🤍`,
  },
  {
    ...
    tag: 'Grief',
    image: imgDeer,
    excerpt: 'It was a particularly dark night… there was a peace about it… it was safe… like being wrapped in a cool blanket… I would often go for walks in the neighborhood… the evening fresh Wisconsin air blowing on my face… the smell of summer green… and jus...',
    body: `(About an 8 min read… it’s a little raw… but very real…)
...
🤍`,
  ...
  {
    slug: 'standing-against-the-giants',
    title: 'Standing Against the Giants',
    date: 'January 17, 2024',
    authors: 'Michael & Katrina',
    readTime: '5 min read',
    tag: 'Faith',
    image: imgGiants,
    excerpt: 'Most of my life has been trial and error… or better known as “The School of Hard Knocks”…',
    body: `(About a 6 min read… it’ll go by fast…)
...
Amburnministries.com

#overcomer #powerful #truth #KingdomOfGod`,
  },
  {
    slug: 'music-through-the-darkness',
    title: 'Music Through the Darkness',
    date: 'January 27, 2024',
    authors: 'Michael & Katrina',
    readTime: '7 min read',
    tag: 'Story',
    image: imgMusicDarkness,
    excerpt: 'My days began to blur together… I was confined, exhausted, and alone… alone is a relative term… It’s more about how I felt than where I was… I felt that no one understood my pain… and that no one understood the problems and challenges that I was f...',
    body: `(About a 7 min read… I cried… so be prepared…)
...
🤍`,
  ...
  {
    slug: 'real-life-encounters',
    title: 'Real Life Encounters',
    date: 'January 11, 2024',
    authors: 'Michael & Katrina',
    readTime: '5 min read',
    tag: 'Testimony',
    image: imgRealLife,
    excerpt: 'This was me… (Upper Left) two weeks after my late wife died… I was slowly coming out of the dark and into the light… I was confused about truth… about life… I felt like a victim… and embraced the identity…',
    body: `(About a 5 min read… but in the end there’s life.)
...
M - God… what do I do… how am I supposed to take care of someone who can’t talk or move?… she’s wasting away and I can’t do anything about it… I’m tired… frustrated… do you even care?…

G - Yes

————

My journaling went on like this for about 2 weeks… I was so frustrated… “other people claim to hear God and have conversation… why not me?… am I not worthy of it?… that must be it…” I would say to myself…
...
#fypchristian #christiantiktok #grace #truth #GodsPlan #Godisgood #God`,
  },
  {
    slug: 'conspiracies',
    title: 'Conspiracies',
    ...
    readTime: '5 min read',
    tag: 'Story',
    image: imgConspiracies,
    excerpt: 'I was raised a skeptic… my father was diagnosed with clinical paranoid schizophrenia… we didn’t discover it until much later in life… he was a unique man… I couldn’t ever connect with him…',
    body: `(About a 5 min read.. it’s sad but true…)
...
Visit our website for more stories like this one!

AmburnMinistries.com/blog`,
  },
  {
    slug: 'today-i-had-something-happen-that-turned-a-45-min-errand-into-a-3-hour-forever-moment',
    title: 'A 3-Hour Forever Moment',
    date: 'January 5, 2024',
    authors: 'Michael & Katrina',
    readTime: '4 min read',
    tag: 'Story',
    image: imgToday,
    excerpt: 'I took my son Zion (2yrs old) with me to target to get dog food. As we were pulling in, I saw two kids, a boy and a girl, frantically looking around the parking lot.',
    body: `(About a 3 min read)
...
Michael`,
  ...
  {
    slug: 'why-you-matter-to-me',
    title: 'Why You Matter to Me',
    date: 'January 5, 2024',
    authors: 'Michael & Katrina',
    readTime: '4 min read',
    tag: 'Faith',
    image: imgWhyYouMatter,
    excerpt: 'It isn’t our past that fully defines us… but the decisions that we make with every step.',
    body: `(About a 4 min read)

It isn’t our past that fully defines us… but the decisions that we make with every step. Stories are important… but they stay in a place that can’t grow… i’ve learned from tragic experience… that the past is… dead… it’s done and nothing can be done to change it… it settles in our histories and in our hearts… but it stays there…

I never knew your father,  Howard Amstutz… but I’ve heard the many fond memories… (Katrina says he would have loved me…) I’ve heard the stories… felt the joy expressed… the hilarious nuances… your honoring thoughts of him… you always speak so highly of your Dad which has intrigued me from the moment I first heard the stories…

The beautiful part of a legacy is that it impacts generation to generation… it’s the passing on of what the heart has collected over a lifetime to a younger vessel that can carry the torch to new heights and lengths…

Dad, your life is a powerful example of a legacy… your successes and pitfalls have built you…. sharpened you… focused you… you’ve always risen above difficulties… you are an overcomer at the deepest level… special forces in the kingdom… you don’t quit and carry it with a silent and steady strength and gentleness…

Im honored to know you… to submit to your authority and wisdom… because of your influence, I am who I’ve become today…

Thank you for being a father to me and so many like me… always seeing the potential… the diamond in the rough… always giving without expecting anything in return… when I see you… I see Jesus… and that means the world to me….
...
Michael`,
  ...
  {
    slug: 'what-does-love-look-like',
    title: 'What Does Love Look Like?',
    date: 'January 5, 2024',
    authors: 'Michael & Katrina',
    readTime: '4 min read',
    tag: 'Faith',
    image: imgWhatLove,
    excerpt: 'I first arrived in Colorado in 2017… I was desperate, hurt and hated the games people played… specifically the church.',
    body: `(About a 4 min read, but worth it!)
...
~ Michael`,
  },
  {
    ...
    tag: 'Faith',
    image: imgTrustMe,
    excerpt: 'I’ve made the way for you. You’re not seeing it… your sight depends on your focus… what are you focusing on?',
    body: `(Prophetic Word for today)

I’ve made the way for you. You’re not seeing it… your sight depends on your focus… what are you focusing on? My Word? Or something else?… seek FIRST my kingdom and my righteousness and THEN all these things will be added unto you…

Willingness is the key… are you willing to look like the fool for me? I often use the foolish things of the world to confound the wise… to me, the most probable direction isn’t usually the case… I want people to look at your life and say “that was God”! How willing are you to trust me with ALL your heart and not to lean on your own understanding… are you ready?

You’ve been tired… leave your own strength behind and begin focusing on me and my kingdom… what do i say? What have I spoken over you? Quiet your heart and listen to me… follow my lead… the path may be  odd and it might seem like it’s heading in the wrong direction, but I know the best way… trust me…

Finally, you’ve been speaking, serving and praying in the quiet for a long time… now it’s time for you to step out… I am with you… I ALWAYS cause you to triumph in Christ Jesus…`,
  },
  {
    slug: 'what-s-to-come',
    ...
    readTime: '3 min read',
    tag: 'Faith',
    image: imgWhatsComing,
    excerpt: 'I, along with many people from my generation, was raised to fear the End Times… my dad would read us selected excerpts from the Book of Revelations… as a kid, I never thought I would reach the age of 18 because the Russians were going to attack an...',
    body: `(About a 3 min read…)

I, along with many people from my generation, was raised to fear the End Times… my dad would read us selected excerpts from the Book of Revelations… as a kid, I never thought I would reach the age of 18 because the Russians were going to attack and enslave us all… it was the era of Red Dawn…

As I grew older I began to get caught up in conspiracy theories and developed a great distaste and distrust for our government… I was opinionated and obstinate ￼against any kind of control…

It’s interesting to me how fear motivates… it takes the a person… convinces them to give up their authority… and then it controls…

In fearing the loss of my perceived control, I was inadvertently giving it away to the enemy… I thought I saw the end of the world within my lifetime… and as I gripped my life tighter… I progressively lost it…

Jesus said that these things would happen… that the end times would come… but I was focusing on the wrong thing. What I was focusing on… I was becoming... and in the name of justice and truth… I convinced a lot of people to be fearful with me…

Here’s the thing… fear is a liar… the word says that many are the afflictions of the righteous, but the lord delivers them from them all… and that gave me hope… it also says that God has not given us a spirit of fear, but of power, love and a sound mind… well… what spirit has he given us then?…

He’s give us His Holy Spirit… as a guide to redirect us away from calamity… to give us favor in the eyes of our adversaries… to equip us to overcome the things the we face on a day to day basis…

I believe in the power of the Holy Spirit, I speak in tongues hourly… sometime out loud and sometime under my breath… I’ve seen and participated in miracles… healings… demonic deliverances and I know without a shadow of a doubt that if/ when the era comes to a close and should I find myself in the midst of calamity… my God has already made a way out of it for me, because he loves me as a good dad does… and He’s given me his Holy Spirit as a GPS to redirect me when there’s trouble up ahead.

Let me ask you: are you filled with the Holy Spirit? Do you have the gift of speaking in tongues? If you answered “no”, then DM me… let’s talk.

Michael`,
  },
  {
    slug: 'the-secrets-we-keep',
    ...
    tag: 'Story',
    image: imgSecrets,
    excerpt: 'I spent months building a hand-crafted and mill worked Cheval mirror for my first wife’s birthday… I spent late nights and numerous days carefully pouring my heart into what I believed to be a visual piece of me… to give to her…',
    body: `(About a 4 min read…)
...
Michael`,
  },
  {
    ...
    tag: 'Story',
    image: imgRealPower,
    excerpt: 'I was 19 and wanted to celebrate mine and my girlfriend’s 2 year dating anniversary… i wanted to make it special….',
    body: `(About a 5 min read… but reading is good for you, right?!)
...
Michael`,
  },
  {
    ...
    tag: 'Testimony',
    image: imgRedemption,
    excerpt: 'I started my life in a seemingly middle class family… I remember my primary days consisting of private school and church… I remember bountiful Christmases and we had what we needed.',
    body: `(Ok… this is about a 10 min read… but it’s Christmas!)
...
Michael`,
  },
  {
    ...
    tag: 'Healing',
    image: imgFromPain,
    excerpt: 'I remember, when I was a kid… a handful of situations that robbed me of my purpose… like a clever pickpocket that taps you on the side to distract you from his slight of hand… I was gullible and easily manipulated… and my father knew it...',
    body: `(About a 5 min read - Warning: I needed a Kleenex)
...
Michael`,
  },
  {
    ...
    tag: 'Testimony',
    image: imgItsForYou,
    excerpt: 'I spent the better part of two years in and out of cancer treatment centers… my wife was diagnosed with stage 4 metastatic breast cancer in 2016… it was new for me… and my loyalty was put to the test…',
    body: `(About a 5 min read… it may be a little cringe… but you’ll be ok…)
...
Michael`,
  ...
  {
    slug: 'fighting-roots-of-worry',
    title: 'Fighting Roots of Worry',
    date: 'January 5, 2024',
    authors: 'Michael & Katrina',
    readTime: '3 min read',
    tag: 'Faith',
    image: imgWorry,
    excerpt: 'Life can be so stressful… it gives us expectations that often turn to obligation… and stress… so, how do we overcome and stand when all odds are against us?',
    body: `(Only a couple min read… but you’ll want to read it again, print it out and tape it to your bathroom mirror.)
...
Michael`,
  ...
  {
    slug: 'peace-within-the-darkness',
    title: 'Peace Within the Darkness',
    date: 'January 5, 2024',
    authors: 'Michael & Katrina',
    readTime: '10 min read',
    tag: 'Healing',
    image: imgPeace,
    excerpt: 'I worked long hours… I would always leave early… it gave me time to process life outside of the issues that were dominant in my life… I would get up at about 4:30am and get ready in peace and quiet… my wife was a heavy sleeper, however… I would st...',
    body: `(About a 10 min read… but it’s still a sprint!)
...
Michael`,
  ...
  {
    slug: 'lessons-in-dreams',
    title: 'Lessons in Dreams',
    date: 'January 5, 2024',
    authors: 'Michael & Katrina',
    readTime: '4 min read',
    tag: 'Faith',
    image: imgDreams,
    excerpt: 'I had a dream a few years ago… that has clung to me to this day…',
    body: `(About a 4 min read… It’ll change your life… )

I had a dream a few years ago… that has clung to me to this day…

I dreamt that I was walking on a road… it was rocky… small pebbles and rocks as far ahead as I was able to see… the sky was blue and partly cloudy… to my left and right were trees, thick brush… briars… vines… the air was humid and thick… it felt like a path through the jungle…

I looked down to notice that I was wearing hiking clothes… I had boots, shorts… and a backpack… I heard the Lord say “keep going”… so I started walking…

As I moved forward, I noticed lamp posts along the road and backpacks… all over… some were lying on the road and others were leaning along the road side… I asked the lord “what are all of those for?”… he replied “that’s your provision”…

As I looked closer, I noticed that some backpacks had health supplies: bandages, splints, gauze, tape, bandaids… another had money in it… another type of back pack had maps, a gps, a compass and books, and the last one had food, water and sustainable goods…

I looked to my right and then my left… I stopped and asked “what’s in the jungle?”… I heard the lord say “you don’t want to go in there”… curiously I approached the jungle… put down my backpack… and entered… it was dark… and became darker as I moved deeper in through the thicket… vines and branches would hit my face… scratching and bruising me…

Before I knew it… I couldn’t see light anymore… feeling afraid… I called out to the Lord for help… immediately I felt Him standing behind me… and to my right I saw a machete in his hand… he said “take this”… and nudged me to the right… I started bushwhacking… cutting my way through the jungle… bugs were all over me… biting and annoying… I was sweating so much that it felt like it was raining… I could hardly see…

Every once in a while, the Lord would hand me a water bottle… I would thank Him… drink it… and continue… I would get so frustrated that I would start telling Him how upset I was that He led me here… he would reply and say “I know it’s hard, but trust me… I’ll lead you out of this”… I’d feel his hand on my shoulder and receive another water bottle and a gentle nudge to the right…

This seemed to go on for days… I was exhausted… hungry… upset and feeling hopeless… after hundreds of water bottles and countless nudges to the right… I saw it… there was light up ahead… I got excited and picked up the pace… the closer I got, the brighter the light was… until… I burst out onto… the same road I had left days before… I looked to the left and, again, there were backpacks and lamp posts as far as I could see… I slowly turned to look to my right… and there it was… my back pack on the road… I was five feet from where I entered the jungle just a few days prior…

I heard the Lord say “My provision is only on the path I choose for you… this is an aspect of my kingdom… you have the freedom to do whatever you want or feel… and I will be with you… I will nudge you to the right and help you with your basic needs… because I love you and I am merciful… however… you won’t receive the blessings and benefits if you’re not on the road… the lampposts represent my promises… when you get a glimpse, it isn’t your goal, but a reminder that you are still walking on the path… do you understand?”… “yes…” I replied…

My eyes were opened that day… a new revelation… a new level of submission… I’ve learned that I’m not my own source… my provision only comes through my agreement with Him…
...
Michael`,
  ...
  {
    slug: 'the-journey-to-healing-deliverance',
    title: 'The Journey to Healing & Deliverance',
    date: 'January 5, 2024',
    authors: 'Michael & Katrina',
    readTime: '5 min read',
    tag: 'Ministry',
    image: imgJourneyHealing,
    excerpt: 'I was raised in the church. It was a good moral foundation, but religious and condemning at the same time.',
    body: `(About a 4 min read… )
...
Michael`,
  },
  {
    ...
    tag: 'Faith',
    image: imgClearCache,
    excerpt: 'I consider myself fairly computer savvy…  but not to long ago I ran into an issue with my computer… there was an error message that said “your storage is full…” so I immediately navigated into my settings app to address the storage issue…  but, th...',
    body: `(About a 2 min read… )

I consider myself fairly computer savvy…  but not to long ago I ran into an issue with my computer… there was an error message that said “your storage is full…” so I immediately navigated into my settings app to address the storage issue…  but, there wasn’t anything extra to delete…. I googled the problem and… no adequate answer was available…

This was very frustrating… I didn’t have time to waste troubleshooting computer issues… my frustration increased as pressures arose… and the compacted pressures of deadlines and stress turned to… worry…

It was then that I started speaking in tongues and hoped the Holy Spirit would have a solution… that’s when I heard the Spirit say “Your Cache is Full…” and sure enough it was! I opened the cache and deleted them… my computer immediately began to function again.

This reminds me of the times in my life where the cares of life… the memories… the failed expectations… and responsibilities… filled up my heart’s cache… I started malfunctioning and I began to feel frustrated about what could possibly be wrong…

In times like these, I remind myself what the word says… “cast your cares on me, because I care for you…” basically, so you don’t we don’t have to!

The process of casting our cares involves trust… do you trust that God can handle what you give him? Be transparent… nothing surprises Him… he doesn’t flinch at bad words or expressive feelings… but he just wants us to come to him for help… and sometimes the answer is as easy as just deleting your cache…

Michael`,
  },
  {
    slug: 'demonic-attacks',
    title: 'Demonic Attacks',
    date: 'January 5, 2024',
    authors: 'Michael & Katrina',
    readTime: '5 min read',
    tag: 'Testimony',
    image: imgDemonic,
    excerpt: 'The year left a lasting mark… there was forward motion, but it was a blur… My late wife and I were experiencing the darkest part of our marriage to date… it was a year of intense violence… blood… broken heartedness… betrayal… and deep pain like I’...',
    body: `(It’s long… so be prepared…)
...
This was the year of shattered glass, shattered dreams and devastating expectations… broken mirrors and broken promises… this was the year that almost killed me… almost… 
I was involved in a Pentecostal church… I was seeking the power of God… I wanted to experience what I’d heard about the Bible… the whole truth and nothing but the truth…
One evening I came home after a long day at the cabinet shop where I worked… the lights were off… the house was completely dark… it was a little daunting and I felt fear come over me…
...
Michael`,
  },
  {
    ...
    tag: 'Faith',
    image: imgFalseAd,
    excerpt: 'When I was 27 years old… I was part of a small Pentecostal church… as part of my seeking experience, I tried many things to discover the power that the Bible mentioned over and over again…',
    body: `(About a 5 min read… if you read fast… )
...
Michael`,
  ...
  {
    slug: 'you-don-t-have-to-try-so-hard',
    title: "You Don't Have to Try So Hard",
    date: 'January 5, 2024',
    authors: 'Michael & Katrina',
    readTime: '4 min read',
    tag: 'Faith',
    image: imgTryHard,
    excerpt: 'When I was 28 I attended a small church in Wisconsin where I had spent most of my adult life… my late wife was raised Pentecostal which often made for interesting conversations between us…',
    body: `(About a 5 min read…)
...
Michael`,
  },
  {
    ...
    tag: 'Story',
    image: imgFather,
    excerpt: 'I was 10. This was the era of Transformers, GI Joe, Jace & the Wheeled Warriors and Rubix… amongst many other toys from the eighties….',
    body: `(About a 4 min read…)
...
Michael`,
  ...
  {
    slug: 'a-tale-of-two-christmas-mugs',
    title: 'A Tale of Two Christmas Mugs',
    date: 'January 5, 2024',
    authors: 'Michael & Katrina',
    readTime: '4 min read',
    tag: 'Story',
    image: imgChristmasMugs,
    excerpt: 'If you look closely… they aren’t the same… hers is less sweet… mine is more so… hers is always gone in seconds… mine can take hours… she requires a throw pillow and a soft blanket… I just need comfortable socks and a place to put up my feet…',
    body: `(About a 2 min read… just a little treat)

If you look closely… they aren’t the same… hers is less sweet… mine is more so… hers is always gone in seconds… mine can take hours… she requires a throw pillow and a soft blanket… I just need comfortable socks and a place to put up my feet…

We talk… we have different perspectives… she has more words… I have less… her smile lights up the room… I don’t naturally wear one… she ties up her hair in a morning messy-bun… I don’t have that luxury and prefer a white ball cap…

However… we could sit and talk for hours… with her drinking four mugs to my one… we could discuss any topic… and discover together… learn from each other… have relationship…

Differences are what make us all amazing… how we see things is so beneficial… differences are a sharpening tool… we need to be sharpened in order to live our lives to the fullest… a dull life is never the desired life… it usually the default…

Let me challenge you… embrace those who challenge you this year… surround yourself with people different than you… who share your vision… you’ll make greater strides if you do…

Our mug rack is eclectic… and that just the way I like it…

Michael`,
  },
  {
    slug: 'the-longest-5-years',
    title: 'The Longest 5 Years',
    date: 'January 5, 2024',
    authors: 'Michael & Katrina',
    readTime: '3 min read',
    tag: 'Story',
    image: imgLongest5,
    excerpt: 'We weren’t looking… our own poor choices and life’s left hooks kept our eyes forward and steady… she was the daughter of what I consider a great family… I was a pantheistic rebel living in a renovated school bus…',
    body: `(About a 3 min read… the anniversary edition!)
...
Michael`,
  ...
  {
    slug: 'fulfilled-dreams',
    title: 'Fulfilled Dreams',
    date: 'January 5, 2024',
    authors: 'Michael & Katrina',
    readTime: '6 min read',
    tag: 'Story',
    image: imgFulfilledDreams,
    excerpt: 'It’s always been my passion… I began playing guitar when I was 14 years old… I took a semester of a very rudimentary intro-to-guitar class in middle school… I loved it from the start…',
    body: `(About a six min read… or watch the reel… it’s faster… )
...
So… after a huge one-day sale discount and a year of no interest financing… I said “ok”… two days later it arrived at my door… it was a day I never thought would happen…
...
Michael`,
  ...
  {
    slug: 'i-was-so-pig-headed',
    title: 'I Was So Pig-Headed',
    date: 'January 5, 2024',
    authors: 'Michael & Katrina',
    readTime: '5 min read',
    tag: 'Story',
    image: imgPigHeaded,
    excerpt: 'A couple months ago, my wife Katrina and I had a disagreement… I told her that I was going to go and clear my head and talk to God about it… There’s always one of two outcomes when this happens… I’m either told that I need to apologize (which is u...',
    body: `(About a 5 min read… with a challenge!)
...
1. Do you feel that I take care of you?
2. Do you feel like I appreciate you?
3. Do you feel like I love you?
4. Do you feel safe with me?
5. Am I a good father?
6. Am I a good husband?
7. Am I a good friend?
8. Am I a good lover?
9. Am I encouraging?
10. Do you feel like you can trust me?
11. Are you excited about our future together?
